...
// CustomDate handles date-only format (YYYY-MM-DD)
type CustomDate struct {
	time.Time
}

// UnmarshalJSON handles JSON parsing for date-only format
...
// MarshalJSON handles JSON output for date-only format
